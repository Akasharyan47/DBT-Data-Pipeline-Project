...
public  class JWTServicesImpl implements JWTService {
    ...
    public   String generateToken(UserDetails userDetails){
        return Jwts.builder().setSubject(userDetails.getUsername())
                ...
                .signWith(getSigniKey() , SignatureAlgorithm.ES256)
                .compact();
    }
    ...
    private Key getSigniKey(){
        byte[] key = Decoders.BASE64.decode("5b5eb1a97d16e7c8f05829e577dd9a46");
     ...
     public boolean isToken(String token , UserDetails userDetails){
        ...
        return (username.equals(userDetails.getUsername()) && !isTokenExpride(token));
     }

    private boolean isTokenExpride(String token) {
